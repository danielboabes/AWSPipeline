...
// import { MyPipelineAppStage } from '/Users/danielboabes/AWSPipeline/lib/stage';
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const pipeline = new CodePipeline(this, 'Pipeline', {
      ...
      synth: new ShellStep('Synth', {
        input: CodePipelineSource.gitHub('danielboabes/AWSPipeline', 'main'), //Remember to change 
        commands: ['npm ci', 
                   'npm run build', 
                   'npx cdk synth']
      })
